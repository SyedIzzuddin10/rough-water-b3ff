...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/hello)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/hello
```

A live public deployment of this template is available at [https://hello.templates.workers.dev](https://hello.templates.workers.dev)
